                            ...
                            <div class="col-md-5">
                                <div class="product-thumbnails-outer">
                                    ...
                                    <div class="product-thumbnails">
                                        <?php if($aproduct['image']){?>
                                        <div class="single-product-item">
                                            <figure class="feature-image">
                                                <img src="<?= base_url("assets/uploads/aproduct/".$aproduct['image']);?>" alt="">
                                            </figure>
                                            
                                            <div class="image-search-icon">
                                                <a href="<?= base_url("assets/uploads/aproduct/".$aproduct['image']);?>" data-fancybox="gallery">
                                                    <i class="fas fa-search"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <?php }?>
                                        <?php if($aproduct['image1']){?>
                                        <div class="single-product-item">
                                            <figure class="feature-image">
                                                <img src="<?= base_url("assets/uploads/aproduct/".$aproduct['image1']);?>" alt="">
                                            </figure>
                                            <div class="image-search-icon">
                                                <a href="<?= base_url("assets/uploads/aproduct/".$aproduct['image1']);?>" data-fancybox="gallery">
                                                    <i class="fas fa-search"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <?php }?>
                                        <?php if($aproduct['image2']){?>
                                        <div class="single-product-item">
                                            <figure class="feature-image">
                                                <img src="<?= base_url("assets/uploads/aproduct/".$aproduct['image2']);?>" alt="">
                                            </figure>
                                            <div class="image-search-icon">
                                                <a href="<?= base_url("assets/uploads/aproduct/".$aproduct['image2']);?>" data-fancybox="gallery">
                                                    <i class="fas fa-search"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <?php }?>
                                        <?php if($aproduct['image3']){?>
                                        <div class="single-product-item">
                                            <figure class="feature-image">
                                                <img src="<?= base_url("assets/uploads/aproduct/".$aproduct['image3']);?>" alt="">
                                            </figure>
                                            <div class="image-search-icon">
                                                <a href="<?= base_url("assets/uploads/aproduct/".$aproduct['image3']);?>" data-fancybox="gallery">
                                                    <i class="fas fa-search"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <?php }?>
                                        <?php if($aproduct['image4']){?>
                                        <div class="single-product-item">
                                            <figure class="feature-image">
                                                <img src="<?= base_url("assets/uploads/aproduct/".$aproduct['image4']);?>" alt="">
                                            </figure>
                                            <div class="image-search-icon">
                                                <a href="<?= base_url("assets/uploads/aproduct/".$aproduct['image4']);?>" data-fancybox="gallery">
                                                    <i class="fas fa-search"></i>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="product-summary">
                                    <h2 class="product-title-name"><?= $aproduct['heading'];?></h2>
                                    <?php /*?>
                        ...
                        <div class="row">
                            <div class=" col-lg-8 right-sidebar">
                                                ...
                                                <div id="collapse-B" class="collapse" data-bs-parent="#nav-tab-content" role="tabpanel" aria-labelledby="heading-B">
                                                    <div class="card-body">
                                                        <table>
                                                            <tr>
                                                                <th>Weight</th>
                                                                <td><?= $aproduct['weight'];?></td>
                                                            </tr>
                                                            <tr>
                                                                <th>Dimensions</th>
                                                                <td><?= $aproduct['dimension'];?></td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
                                ...
                                <div class="related-product">
                                    ...
                                    <div class="row">
                                        <?php $aproductLists = productList(4);
                                         if($aproductLists){
                                            ...
                                            <div class="product-item text-center">
                                                <figure class="product-image">
                                                    <a href="<?= base_url();?>product/<?= $product['heading_slug'];?>">
                                                        <img src="<?= base_url("assets/uploads/aproduct/".$product['thumb_image']);?>" alt="">
                                                    </a>
                                                </figure>
