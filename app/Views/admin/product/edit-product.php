            ...
            <form class="form-sample">
                    <fieldset>
                        ...
                        <div class="row" id="options-container">
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="form-group">
                                    <label>Thumb Image <img src="<?= base_url("assets/uploads/product/".$product['thumb_image']);?>" style="width:30px" alt=""></label>
                                ...
                                <div class="col-md-3 mb-2">
                                    <div class="form-group">
                                        <label>Image <img src="<?= base_url("assets/uploads/product/".$product['image']);?>" style="width:30px" alt=""></label>
                                ...
                                <div class="col-md-3 mb-2">
                                    <div class="form-group">
                                        <label>Image1 <img src="<?= base_url("assets/uploads/product/".$product['image1']);?>" style="width:30px" alt=""></label>
                                ...
                                <div class="col-md-3 mb-2">
                                    <div class="form-group">
                                        <label>Image2 <img src="<?= base_url("assets/uploads/product/".$product['image2']);?>" style="width:30px" alt=""></label>
                                ...
                                <div class="col-md-3 mb-2">
                                    <div class="form-group">
                                        <label>Image3 <img src="<?= base_url("assets/uploads/product/".$product['image3']);?>" style="width:30px" alt=""></label>
                                ...
                                <div class="col-md-3 mb-2">
                                    <div class="form-group">
                                        <label>Image4 <img src="<?= base_url("assets/uploads/product/".$product['image4']);?>" style="width:30px" alt=""></label>
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label>Og Image <img src="<?= base_url("assets/uploads/product/".$product['og_image']);?>" style="width:30px" alt=""></label>
