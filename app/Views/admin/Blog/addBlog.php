            ...
            <div class="card-body">
                <form class="form-sample">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="heading_slug" class='form-control'>
                                    <div class='clearfix'></div>
                    ...
                    <fieldset>
                        ...
                        <button type="button" id="authenticateBlogCreate"
...
<script src="<?= base_url("assets/admin/page/blog.js?v=0.1") ?>"></script>