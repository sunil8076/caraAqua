<div class="page-header">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Blog</a></li>
...
<div class='row'>
  <div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        <div class="mb-4">
          <h4 class="card-title mb-sm-0">Blog List</h4>
          <a href="<?= base_url();?>admin/blog/create-blog" class="ml-auto badge badge-warning p-2 float-right">Create
            Blog</a>
        </div>
        <p>&nbsp;</p>
            ...
            if ($blogList) {
              ...
              foreach ($blogList as $blog) { ?>
                <tr>
                  ...
                  <td data-label="heading"><?php echo $blog["heading"] ?></td>
                  <td data-label="Action">
                    <a href="<?= base_url() ?>admin/blog/edit-blog/<?php echo $blog['id']; ?>"
                      class="ml-auto badge badge-warning p-2"><i class="fa fa-pencil"></i></a>
                    <?php if ($blog['status'] == 1) { ?>
                      <a href="<?php echo base_url("admin/blog/updateStatus/" . $blog['id'] . "/0"); ?>"
                    ...
                    <?php } else { ?>
                      <a href="<?php echo base_url("admin/blog/updateStatus/" . $blog['id'] . "/1"); ?>"
                        class="badge badge-danger p-2" onclick="return confirm('Are you sure. You want to activate this?')"><i
                          class="fa fa-times" aria-hidden="true"></i></a>
                    <?php } ?>
                    <a href="<?= base_url() ?>admin/blog/delete-blog/<?php echo $blog['id']; ?>"
