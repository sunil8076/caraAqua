<div class="page-header">
            <h3 class="page-title">Service Enquiry List</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Enquiry</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Service Enquiry</li>
                </ol>
            </nav>
        </div>
        <div class='row'>
                      ...
                      <table Id="example" class="display table table-bordered" width="100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td data-label="service_name"><?php echo $enquiry["service_name"];?></td>
                            ...
                            <td data-label="date"><?= date("d-m-Y h:i A", strtotime($enquiry["date"])) ?></td>
