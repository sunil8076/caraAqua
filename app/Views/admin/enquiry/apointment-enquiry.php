<div class="page-header">
            <h3 class="page-title">Apointment Enquiry List</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="javascript:void(0)">Manage Enquiry</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Apointment Enquiry</li>
                </ol>
            </nav>
        </div>
        <div class='row'>
                      ...
                      <table Id="example" class="display table table-bordered" width="100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td data-label="message"><?php echo $enquiry["message"]?></td>
